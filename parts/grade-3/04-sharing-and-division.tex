...
23 = 4 \times 5 + 3 ,
\]
and say: the \emph{quotient}\index{quotient} is $5$, the
...
$7 \times 8 = 56$ is the biggest \omterm{def:g2:mult:def}{product} that fits under $58$
($7 \times 9 = 63$ is too much). So
\[
58 = 7 \times 8 + 2 :
\]
\omterm{def:g3:division:remainder}{quotient} $8$, \omterm{def:g3:division:remainder}{remainder} $2$. Check: $56 + 2 = 58$, and $2 < 7$.
\end{example}

\begin{method}[Interpreting the remainder]\label{met:g3:division:interpret}
After dividing, return to the story:
\begin{enumerate}
  \item ``how many each / how many full groups?'' --- the \omterm{def:g3:division:remainder}{quotient};
  \item ``how many left over?'' --- the \omterm{def:g3:division:remainder}{remainder};
  \item ``how many boxes to hold everything?'' --- the \omterm{def:g3:division:remainder}{quotient}
        \emph{plus one} if the \omterm{def:g3:division:remainder}{remainder} is not \omterm{def:g1:counting:zero}{zero}.
\end{enumerate}
\end{method}
...
The \emph{half}\index{half} of a number is the result of dividing it by $2$; the
\emph{third}, by $3$; the \emph{quarter}\index{quarter}, by $4$. For instance the
...
The \omterm{def:g3:division:half}{half} of $46$: since $46 = 40 + 6$, \omterm{def:g3:division:half}{half} of each part gives
...
the \omterm{def:g3:division:remainder}{quotient} and the \omterm{def:g3:division:remainder}{remainder}: $17 \div 5$; \quad $30 \div 4$; \quad
$50 \div 6$.
\end{exercise}
...
Compute: the \omterm{def:g3:division:half}{half} of $68$; the third of $27$; the \omterm{def:g3:division:half}{quarter} of $48$;
the \omterm{def:g3:division:half}{half} of $150$.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g3:division:5}
True or false? Check with a multiplication.
``$45 \div 5 = 9$''; \quad ``$52 \div 6 = 8$ \omterm{def:g3:division:remainder}{remainder} $4$'';
\quad ``$70 \div 8 = 9$ \omterm{def:g3:division:remainder}{remainder} $2$''.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g3:division:6}
$32$ photos are glued into an album, $4$ per page. How many pages are
used? Which \omterm{def:g2:shapes:solids}{face} of division is this (sharing or grouping)?
\end{exercise}
...
$54 \div ? = 6$; \quad the \omterm{def:g3:division:half}{half} of $?$ is $35$.
\end{exercise}
...
\omterm{def:g3:division:remainder}{remainders}? What is the biggest number whose division by $6$ has
\omterm{def:g3:division:remainder}{quotient} $7$?
\end{exercise}
