...
thousands, a $7$ in the units, and \emph{\omterm{def:g1:counting:zero}{zeros}} in between to keep
...
\begin{enumerate}
  ...
  \item Write the answer with the signs $<$ (smaller than) or $>$
        (bigger than): the open side always \omterm{def:g2:shapes:solids}{faces} the bigger number.
\end{enumerate}
\end{method}
...
\begin{example}
$46$ is \omterm{def:g3:numbers:evenodd}{even} ($46 = 23 + 23$); $47$ is \omterm{def:g3:numbers:evenodd}{odd} (two equal parts would
need half an object). Only the \emph{last} digit matters: $3\,578$ is
\omterm{def:g3:numbers:evenodd}{even}, $2\,341$ is \omterm{def:g3:numbers:evenodd}{odd}.
\end{example}
...
{\small \omterm{def:g3:numbers:evenodd}{Even numbers} split into two equal rows; \omterm{def:g3:numbers:evenodd}{odd numbers} always
leave one alone.}
\end{omfigure}
...
\omterm{def:g3:numbers:evenodd}{Even} or \omterm{def:g3:numbers:evenodd}{odd}? \ $34$; \ $57$; \ $70$; \ $2\,481$; \ $6\,548$.
\end{exercise}
...
I am a three-digit number. My digits are $2$, $5$ and $8$, I am \omterm{def:g3:numbers:evenodd}{even},
