...
\emph{1. Waar}: dit is de productregel (\cref{thm:g9:sqrt:rules}).

\emph{2. Onwaar}: $\sqrt{9 + 16} = 5$ maar $\sqrt9 + \sqrt{16} = 7$.

\emph{3. Onwaar} voor negatieve $x$: $\sqrt{(-4)^2} = 4 \neq -4$. De
juiste uitspraak is $\sqrt{x^2} = \abs{x}$.

\emph{4. Waar}: $\left(3\sqrt2\right)^2 = 9 \times 2 = 18$.
\end{solution}

\begin{solution}{exo:g9:sqrt:10}
$\left(2 + \sqrt3\right)^2 = 4 + 4\sqrt3 + 3 = 7 + 4\sqrt3$. Dus
$x = \sqrt{7 + 4\sqrt3} = \sqrt{\left(2+\sqrt3\right)^2} = 2 + \sqrt3$
(een niet-negatief getal, dus de wortel haalt gewoon het kwadraat
weg).

Evenzo $\left(\sqrt5 - 2\right)^2 = 5 - 4\sqrt5 + 4 = 9 - 4\sqrt5$,
en $\sqrt5 - 2 > 0$, dus
$\sqrt{9 - 4\sqrt5} = \sqrt5 - 2$ (niet $2 - \sqrt5$, dat negatief
is!).
\end{solution}
