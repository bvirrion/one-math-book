...
$3^4 \times 7^4 = 21^4$ (zelfde \omterm{def:g8:powers:def}{exponent}: vermenigvuldig de
grondtallen).
\end{solution}
...
$2^3 \times 2^4 = 2^{12}$: \emph{onwaar} --- \omterm{def:g8:powers:def}{exponenten} tellen op:
$2^7$.
