...
lettres $b$, que l'on peut regrouper. La règle du quotient vient
...
exposant commun, pour la dernière). Aucune règle ne simplifie
...
$10^{-n} = 0.\underbrace{0\dots0}_{n-1}1$. Les règles des exposants
...
$4.7 \times 10^{-3} = 0.0047$ (décaler la virgule,
...
\begin{enumerate}
  ...
  \item appliquer les règles d'exposants au sein de chaque base~;
...
Écrire comme un nombre décimal~: $10^{-2}$~; \quad $4 \times 10^3$~;
...
\begin{enumerate}
  \item Exprimer l'épaisseur après $10$ plis comme un produit, et la
