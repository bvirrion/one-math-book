...
rendent l'algèbre puissante~: \emph{développer} des produits de
parenthèses, et \emph{résoudre des équations} --- trouver le nombre
...
{\small Double distributivité comme aires~: le rectangle
...
\begin{enumerate}
  \item Développer chaque produit, en écrivant chaque terme avec son
        signe~;
...
{\small Une équation est une balance en équilibre~: tout ce qui est
...
\begin{enumerate}
  ...
  \item traduire l'histoire en une équation~;
  \item la résoudre~;
...
équation a d'ordinaire une solution, une inégalité en a toute une
demi-droite.
\end{example}
...
périmètre est $58$ cm. Soit $x$ la largeur~: écrire une équation, la
résoudre et donner les deux dimensions.
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g8:equations:9}
Trois nombres entiers consécutifs ont pour somme $141$. Appeler le
...
Résoudre l'équation $\dfrac{x + 3}{4} = \dfrac{2x - 1}{5}$.
(Multiplier les deux membres par $20$, le dénominateur commun, puis
procéder comme d'habitude~; vérifier la solution dans l'équation
originale.)
\end{exercise}
