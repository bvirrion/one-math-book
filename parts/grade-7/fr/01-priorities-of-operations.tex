...
\section{Problème~: multiplier comme un scribe égyptien}

\begin{problem}[{Devoir maison --- des astuces de calcul mental
issues de la distributivité, et la multiplication par doublements et
moitiés utilisée depuis quatre mille ans}]
\label{pb:g7:priorities:1}
Bien avant les calculatrices --- et avant que les tables de
multiplication ne s'apprennent à l'école --- les scribes égyptiens et
les paysans russes multipliaient deux nombres quelconques en ne se
servant que de \emph{doublements, de \omterm{def:g3:division:half}{moitiés} et d'additions}. Leur
méthode a l'air magique~; c'est en réalité la distributivité
(\cref{thm:g7:priorities:distributivity}) déployée à pleine
puissance. Ce problème aiguise d'abord le calcul mental, enseigne
ensuite la méthode antique, puis ouvre le capot pour voir exactement
pourquoi elle fonctionne.

\medskip
\noindent\textbf{Partie I --- L'art de ne pas calculer.}
\begin{enumerate}
  \item Calculer mentalement, en développant comme dans
        \cref{ex:g7:priorities:distributivity}~: $7 \times 102$ et
        $9 \times 98$.
  \item Calculer mentalement, en factorisant~:
        $17 \times 13 + 17 \times 7$ et $45 \times 101 - 45$.
  \item L'astuce du «~fois $5$~»~: pour multiplier par $5$,
        multiplier par $10$ et prendre la \omterm{def:g3:division:half}{moitié}. Calculer
        $5 \times 87$ de cette façon, et expliquer pourquoi
        l'astuce est légitime.
  \item Deux autres astuces à justifier et à utiliser~: multiplier
        par $25$ en multipliant par $100$ et en divisant par $4$
        (calculer $25 \times 32$)~; multiplier par $99$ en
        multipliant par $100$ et en retranchant une fois (calculer
        $99 \times 47$).
  \item Un coup de semonce~: la distributivité répartit un facteur
        sur une \emph{\omterm{def:g1:addition:def}{somme}}, jamais sur un \omterm{def:g2:mult:def}{produit}. Comparer
        $8 \times (5 + 3)$ avec $8 \times 5 + 8 \times 3$, puis
        $8 \times (5 \times 3)$ avec
        $(8 \times 5) \times (8 \times 3)$~: quel couple concorde,
        quel couple ne concorde pas~?
\end{enumerate}

\medskip
\noindent\textbf{Partie II --- La méthode des doublements et des
\omterm{def:g3:division:half}{moitiés}.}
Voici la recette pour $13 \times 24$. Écrire deux colonnes. Colonne
de gauche~: partir de $13$ et prendre la \emph{\omterm{def:g3:division:half}{moitié}}, en laissant
tomber tout \omterm{def:g3:division:remainder}{reste}, jusqu'à $1$~: \ $13,\ 6,\ 3,\ 1$. Colonne de
droite~: partir de $24$ et \emph{doubler} autant de fois~: \
$24,\ 48,\ 96,\ 192$. Barrer toute ligne dont le nombre de
\emph{gauche} est \omterm{def:g3:numbers:evenodd}{pair}, et additionner les nombres de droite
survivants.
\begin{enumerate}[resume]
  \item Appliquer la recette à $13 \times 24$~: quelle ligne est
        barrée, quelle \omterm{def:g1:addition:def}{somme} reste-t-il, et vaut-elle bien
        $13 \times 24$~?
  \item Multiplier $21 \times 17$ par la méthode (\omterm{def:g3:division:half}{moitiés} de $21$,
        doublements de $17$), et vérifier le résultat par une
        multiplication ordinaire.
  \item Multiplier $16 \times 25$ par la méthode. Combien de lignes
        survivent, et qu'a de particulier une colonne de gauche qui
        démarre à $1$, $2$, $4$, $8$, $16, \dots$~?
  \item Voyons maintenant \emph{pourquoi} cela marche, une étape à
        la fois. Justifier chaque égalité par la distributivité~:
        \[
        13 \times 24 = (12 + 1) \times 24
        = 12 \times 24 + 24 = 6 \times 48 + 24 .
        \]
        Morale~: prendre la \omterm{def:g3:division:half}{moitié} à gauche et doubler à droite
        conserve le \omterm{def:g2:mult:def}{produit} --- mais lorsque le nombre de gauche est
        \emph{\omterm{def:g3:numbers:evenodd}{impair}}, un exemplaire du nombre de droite se détache
        et doit être mis de côté. Quel nombre la première ligne du
        tableau met-elle de côté~?
  \item Poursuivre la comptabilité en descendant le tableau~:
        $6 \times 48 = 3 \times 96$, puis
        $3 \times 96 = 1 \times 192 + 96$, puis
        $1 \times 192 = 192$. Rassembler tout ce qui a été mis de
        côté en chemin, et expliquer pourquoi les nombres mis de
        côté sont exactement les nombres de droite des lignes dont
        la gauche est impaire --- les lignes que la recette
        conserve.
\end{enumerate}

\medskip
\noindent\textbf{Partie III --- Sous le capot~: des \omterm{def:g1:addition:def}{sommes} de
doublements.}
\begin{enumerate}[resume]
  \item À la question 6, les lignes survivantes valaient $1$, $4$
        et $8$ doublements de $24$~: la méthode a écrit en silence
        $13 \times 24 = (1 + 4 + 8) \times 24$. Vérifier que
        $1 + 4 + 8 = 13$, et trouver quels doublements ($1$, $2$,
        $4$, $8$, $16$) la méthode a retenus pour $21$ à la
        question 7.
  \item Écrire $25$ et $42$ comme \omterm{def:g1:addition:def}{sommes} de nombres de la liste des
        doublements $1, 2, 4, 8, 16, 32$, en utilisant chacun au
        plus une fois.
  \item Expliquer pourquoi \emph{tout} nombre entier peut s'écrire
        ainsi~: prendre le plus grand doublement qui tient,
        soustraire, recommencer --- pourquoi cela s'arrête-t-il
        forcément~? Écrire $100$ sous cette forme.
  \item Les scribes d'Égypte faisaient exactement cela, il y a
        quatre mille ans~: pour multiplier $19 \times 35$, ils
        dressaient un tableau de doublements de $35$
        ($1 \to 35$, $2 \to 70$, $4 \to 140$, $8 \to 280$,
        $16 \to 560$), choisissaient les lignes dont la \omterm{def:g1:addition:def}{somme} vaut
        $19$, et additionnaient. Mener le calcul à leur manière.
  \item Bouquet final~: les ordinateurs modernes, qui comptent avec
        des $0$ et des $1$, multiplient essentiellement comme les
        scribes --- par doublements et additions. Quelles trois
        additions un ordinateur ferait-il pour $13 \times 24$~?
        (Pourquoi tout nombre se décompose en doublements, et ce que
        les $0$ et les $1$ viennent y faire, est le devoir maison du
        chapitre sur les puissances~: \cref{pb:g8:powers:1}.)
\end{enumerate}
\end{problem}
