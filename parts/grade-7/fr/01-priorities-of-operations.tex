...
Une barre de fraction regroupe son numérateur et son dénominateur,
...
Compter l'aire d'un rectangle de largeur $k$ découpé en deux
rectangles plus petits de longueurs $a$ et $b$~: en un seul morceau
c'est $k \times (a+b)$~; en deux parties c'est
$k \times a + k \times b$. Même rectangle, même aire.
\end{proof}
...
{\small Distributivité vue comme aires~: le grand rectangle
$k \times (a + b)$ est la somme des deux plus petits.}
\end{omfigure}
...
«~La somme de $8$ et du produit de $5$ par $3$~» s'écrit
$8 + 5 \times 3 = 23$. «~Le produit de $5$ par la somme de $8$ et
$3$~» s'écrit $5 \times (8 + 3) = 55$~: les mots «~le produit
de~\dots\ par la somme de~\dots~» placent des parenthèses autour de
la somme.
\end{example}
...
calculer~: «~la différence de $50$ et du produit de $6$ par $7$~»~;
