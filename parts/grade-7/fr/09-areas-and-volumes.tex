...
intégral, présenté dans le \omterm{def:g6:measure:volume}{volume} suivant de cette série.
\end{proof}
...
\section{Problème~: le carré qui s'évanouit}

\begin{problem}[{Devoir maison --- une célèbre «~preuve~» que
$64 = 65$, démasquée par les aires et les pentes, avec pizzas et
anneaux pour le dessert}]
\label{pb:g7:areas:1}
Un magicien découpe un carré $8 \times 8$ en quatre pièces, les fait
glisser, et les rassemble en un rectangle $5 \times 13$. Le public
compte~: $8 \times 8 = 64$, mais $5 \times 13 = 65$ --- une unité
d'\omterm{def:g6:measure:area}{aire} est apparue de nulle part~! Les formules d'\omterm{def:g6:measure:area}{aire} de ce chapitre
sont exactement les outils qui démasquent le tour. Le problème met
ensuite le raisonnement honnête sur les \omterm{def:g6:measure:area}{aires} au travail~: sur des
trapèzes, sur des piles inclinées, sur l'économie de la pizza --- et
revient enfin au magicien pour un second numéro, plus étrange encore.

\medskip
\noindent\textbf{Partie I --- Le tour, exécuté puis démasqué.}
Les quatre pièces du carré $8 \times 8$ sont~: deux \omterm{def:g6:shapes:triangles}{triangles
rectangles} de côtés de l'\omterm{def:g3:shapes:rightangle}{angle droit} $8$ et $3$, et deux trapèzes
rectangles de côtés \omterm{def:g6:lines:perp}{parallèles} $5$ et $3$ et de hauteur $5$.
\begin{enumerate}
  \item Calculer l'\omterm{def:g6:measure:area}{aire} du carré de départ et l'\omterm{def:g6:measure:area}{aire} du rectangle
        annoncé. Énoncer le scandale en une ligne.
  \item Calculer l'\omterm{def:g6:measure:area}{aire} de chacune des quatre pièces
        (\cref{thm:g7:areas:triangle}~; pour les trapèzes, découper
        ou utiliser \cref{exo:g7:areas:9}).
  \item Additionner les quatre \omterm{def:g6:measure:area}{aires}. Laquelle des deux figures ---
        le carré ou le rectangle --- les pièces peuvent-elles
        réellement remplir~?
  \item Dans la disposition en rectangle, l'hypoténuse d'un triangle
        (qui monte de $3$ sur $8$) est censée prolonger le côté
        oblique d'un trapèze (qui monte de $2$ sur $5$) en une seule
        «~diagonale~» droite. Tester l'alignement~: monter de $3$
        sur $8$ et monter de $2$ sur $5$, est-ce la même pente
        (\cref{thm:g7:prop:cross})~?
  \item Expliquer où se cache le soixante-cinquième carré~: quelle
        est la forme du vide le long de la fausse diagonale, quelle
        est son \omterm{def:g6:measure:area}{aire} exacte, et pourquoi l'œil ne le voit-il pas~?
        (Quelle largeur moyenne a une écharde de cette \omterm{def:g6:measure:area}{aire} étirée
        sur la diagonale du rectangle, longue d'environ $13$
        unités~?)
\end{enumerate}

\medskip
\noindent\textbf{Partie II --- Raisonner honnêtement sur les \omterm{def:g6:measure:area}{aires}.}
\begin{enumerate}[resume]
  \item Tracer deux \omterm{def:g6:lines:perp}{droites parallèles} distantes de $4$ cm, une base
        de $6$ cm sur l'une d'elles, et trois triangles différents
        sur cette base, dont les \omterm{def:g5:solids:def}{sommets} sont pris en divers points
        de l'autre droite. Calculer les trois \omterm{def:g6:measure:area}{aires}. Pourquoi
        sont-elles toutes égales, où que le \omterm{def:g5:solids:def}{sommet} glisse sur sa
        droite~?
  \item Démontrer la formule du trapèze en général~: un trapèze de
        côtés \omterm{def:g6:lines:perp}{parallèles} $B$ et $b$ et de hauteur $h$, coupé suivant
        une diagonale, donne deux triangles de même hauteur $h$.
        Conclure~:
        \[
        A = \frac{(B + b) \times h}{2} .
        \]
  \item L'appliquer à un trapèze où $B = 9$ cm, $b = 5$ cm,
        $h = 4$ cm.
  \item Les charpentiers utilisent la même formule sous un autre
        habit~: \omterm{def:g6:measure:area}{aire} $=$ (moyenne des deux côtés \omterm{def:g6:lines:perp}{parallèles})
        $\times$ hauteur. Expliquer pourquoi c'est la même règle, et
        refaire la question 8 de cette façon.
  \item Incliner une pile bien rangée de cartes à jouer pour en
        faire une pile penchée. Expliquer pourquoi le \omterm{def:g6:measure:volume}{volume} n'a pas
        changé, et ce que cela dit de la hauteur dans la formule du
        \omterm{def:g7:areas:prism}{prisme} $V = B \times h$
        (\cref{thm:g7:areas:volume})~: quelle hauteur faut-il
        prendre pour une pile penchée --- la longueur oblique ou la
        hauteur verticale~? (Comparer avec
        \cref{exo:g7:areas:2}, une dimension plus bas.)
\end{enumerate}

\medskip
\noindent\textbf{Partie III --- Anneaux, pizzas et le retour du
magicien.}
\begin{enumerate}[resume]
  \item Un bassin circulaire de \omterm{def:g3:shapes:shapes}{rayon} $3$ m occupe le centre d'une
        pelouse circulaire de \omterm{def:g3:shapes:shapes}{rayon} $5$ m. Calculer l'\omterm{def:g6:measure:area}{aire} de
        l'anneau de gazon (exacte avec $\pi$, puis arrondie au
        m$^2$).
  \item Trouver le \omterm{def:g3:shapes:shapes}{rayon} du disque unique dont l'\omterm{def:g6:measure:area}{aire} vaut
        exactement celle de cet anneau. (Les trois \omterm{def:g3:shapes:shapes}{rayons} dont on
        dispose désormais forment un triplet célèbre, dont
        l'histoire est racontée au \cref{ch:g8:pythagoras}.)
  \item Qu'est-ce qui fait le plus de pizza~: une pizza de \omterm{def:g4:geometry:circle}{diamètre}
        $40$ cm, ou deux pizzas de \omterm{def:g4:geometry:circle}{diamètre} $28$ cm~? Calculer et
        comparer.
  \item Pour \emph{doubler} l'\omterm{def:g6:measure:area}{aire} d'une pizza, par quel facteur son
        \omterm{def:g3:shapes:shapes}{rayon} doit-il grandir, à peu près~? Tester le candidat $1.4$
        (se rappeler que les \omterm{def:g6:measure:area}{aires} suivent le \emph{carré} du
        facteur d'agrandissement, \cref{pb:g6:propdata:1}), et dire
        où le facteur exact --- le nombre dont le carré vaut $2$ ---
        fait son entrée officielle
        (\cref{ex:g8:pythagoras:diagonal}).
  \item Le magicien revient~: il découpe un carré $13 \times 13$ où
        les nombres $5$, $8$, $13$ jouent les rôles tenus tout à
        l'heure par $3$, $5$, $8$, et rassemble un rectangle
        $8 \times 21$. Calculer les deux \omterm{def:g6:measure:area}{aires}~: qu'est-ce qui
        s'évanouit cette fois~? Les nombres $3, 5, 8, 13, 21$ sont
        des termes consécutifs de la suite du
        \cref{pb:g7:fractions:1} --- énoncer la régularité des gains
        et des pertes du magicien, et la morale~: pourquoi les \omterm{def:g6:measure:area}{aires}
        ne mentent-elles jamais~?
\end{enumerate}
\end{problem}
