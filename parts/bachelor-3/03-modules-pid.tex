...
theorems. A \omterm{def:b3:modules:module}{module} over $\Z$ is an abelian group; a \omterm{def:b3:modules:module}{module} over
$K[X]$ is a vector space equipped with an endomorphism. The
structure theorem for \omterm{def:b3:modules:free}{finitely generated modules} over a \omterm{def:b3:rings:pidufd}{PID}
therefore classifies, in one stroke, all \omterm{def:b3:modules:free}{finitely generated}
...
computational engine is the \omterm{thm:b3:modules:smith}{Smith normal form}, an arithmetic of
matrices worthy of Euclid.

Throughout, $A$ is a commutative ring, soon a \omterm{def:b3:rings:pidufd}{PID}; ``\omterm{def:b3:modules:module}{module}''
means $A$-module.
...
\begin{enumerate}
  \item $A = K$ a field: \omterm{def:b3:modules:module}{modules} are vector spaces.
  \item $A = \Z$: \omterm{def:b3:modules:module}{modules} are exactly abelian groups ($nx$ is
        forced to be $x + \dots + x$), submodules are subgroups.
  \item $A = K[X]$: a \omterm{def:b3:modules:module}{module} is a $K$-vector space $V$ together
...
\end{enumerate}
An \omterm{def:b3:rings:ideal}{ideal} of $A$ is exactly a submodule of $A$; a \omterm{def:b3:rings:ideal}{quotient ring}
$A/I$ is an $A$-module. Unlike vector spaces, \omterm{def:b3:modules:module}{modules} can have
\emph{\omterm{def:b3:modules:torsion}{torsion}}: in $\Z/6\Z$, the element $\bar 3 \ne 0$ is killed
by $2 \neq 0$.
\end{example}
...
quotient of a free \omterm{def:b3:modules:module}{module}: $(a_1, \dots, a_n) \mapsto \sum a_ix_i$
maps $A^n$ onto $M$.
\end{definition}
...
\begin{proof}
Pick a \omterm{def:b3:rings:primemaximal}{maximal ideal} $\mathfrak m$ of $A$ (\cref{thm:b3:rings:krull})
...
Let $A$ be a \omterm{def:b3:rings:pidufd}{PID} and $M \subseteq A^n$ a submodule. Then $M$ is
\omterm{def:b3:modules:free}{free} of rank $\leq n$.
\end{theorem}

\begin{proof}
Induction on $n$. For $n = 1$: $M$ is an \omterm{def:b3:rings:ideal}{ideal}, so $M = (0)$
(\omterm{def:b3:modules:free}{free} of rank $0$) or $M = dA \cong A$ ($x \mapsto dx$ is
injective: domain). For $n > 1$: let $\pi \colon A^n \to A$ be the
last coordinate. Then $\pi(M)$ is an \omterm{def:b3:rings:ideal}{ideal}, $(0)$ or $dA$. If
...
\ker \pi \cong A^{n-1}$ is \omterm{def:b3:modules:free}{free} of rank $\leq n - 1$; adjoining
...
Consequently, over a \omterm{def:b3:rings:pidufd}{PID} every \omterm{def:b3:modules:free}{finitely generated module} $M$ has a
\emph{finite presentation}: a surjection $\varphi\colon A^n \to M$
has \omterm{def:b3:modules:free}{free} kernel with basis $c_1, \dots, c_k$ ($k \leq n$), and $M
...
presentation matrices define isomorphic \omterm{def:b3:modules:module}{modules} $A^n/
\operatorname{im}$ (change bases in $A^n$ and $A^k$).
\end{definition}

\begin{theorem}[Smith normal form]\label{thm:b3:modules:smith}
Let $A$ be a \omterm{def:b3:rings:pidufd}{PID} and $B \in M_{n,k}(A)$. Then $B$ is equivalent to
a diagonal matrix\index{Smith normal form}
\[
\operatorname{diag}(d_1, d_2, \dots, d_r, 0, \dots, 0),
\qquad d_1 \mid d_2 \mid \cdots \mid d_r \neq 0 ,
\]
and the $d_i$ are unique up to \omterm{def:b3:rings:divisibility}{associates}: $d_1 \cdots d_i$ is a
...
\omterm{def:b3:rings:ideal}{ideals} $(b)$ generated by entries of matrices equivalent to $B$;
since $A$ is \omterm{def:b3:rings:noetherian}{Noetherian}, choose a matrix $B'$ equivalent to $B$
...
Over a \omterm{def:b3:rings:pidufd}{Euclidean domain} ($\Z$, $K[X]$), Smith reduction is an
...
rank drop (the cokernel picks up a \omterm{def:b3:modules:free}{free} $\Z$ summand), and the
...
points). The \omterm{thm:b3:modules:smith}{Smith normal form} of $\bigl(\begin{smallmatrix} 2 &
...
$M$ is \emph{\omterm{def:b3:modules:free}{torsion-free}} if $T(M) = 0$, a \emph{torsion \omterm{def:b3:modules:module}{module}}
if $T(M) = M$.
\end{definition}

\begin{theorem}[Structure of finitely generated modules over a
PID]\label{thm:b3:modules:structure}
Let $A$ be a \omterm{def:b3:rings:pidufd}{PID} and $M$ a \omterm{def:b3:modules:free}{finitely generated} $A$-module. There
exist a unique $r \in \N$ and nonzero nonunits $d_1 \mid d_2 \mid
\cdots \mid d_s$, unique up to \omterm{def:b3:rings:divisibility}{associates}, with\index{structure
theorem for modules}
\[
M \;\cong\; A^r \,\oplus\, A/(d_1) \oplus \cdots \oplus A/(d_s).
\]
Moreover $T(M) \cong A/(d_1)\oplus\dots\oplus A/(d_s)$ and $M/T(M)
\cong A^r$: a \omterm{def:b3:modules:free}{finitely generated} \emph{\omterm{def:b3:modules:torsion}{torsion-free}} \omterm{def:b3:modules:module}{module} over a
\omterm{def:b3:rings:pidufd}{PID} is \omterm{def:b3:modules:free}{free}.
\end{theorem}
...
\emph{The \omterm{def:b3:modules:torsion}{torsion} identification.} In the decomposition, $A^r$ is
\omterm{def:b3:modules:torsion}{torsion-free} (a domain has no zero divisors) and each $A/(d_i)$
is \omterm{def:b3:modules:torsion}{torsion} (killed by $d_i \ne 0$); a direct sum splits \omterm{def:b3:modules:torsion}{torsion}
...
\emph{Uniqueness of the $d_i$}: it suffices to treat the \omterm{def:b3:modules:torsion}{torsion
module} $T = T(M)$. Decompose each $d_i$ into primes and split by
the Chinese remainder theorem (\cref{thm:b3:rings:crt}; distinct
primes generate \omterm{thm:b3:rings:crt}{comaximal ideals}):
\[
...
multiset of \omterm{thm:b3:modules:structure}{elementary divisors} ($d_s$ = product of the highest
...
Every \omterm{def:b3:modules:free}{finitely generated} abelian group is $\Z^r \times
...
\cdot x = P(u)(x)$ (\cref{ex:b3:modules:examples}). This \omterm{def:b3:modules:module}{module}
is \omterm{def:b3:modules:free}{finitely generated} (a $K$-basis generates) and \omterm{def:b3:modules:torsion}{torsion}: for
...
\begin{enumerate}
  \item $P_s = \mu_u$ (minimal polynomial) and $P_1\cdots P_s =
        ...
        the same \omterm{def:b3:rings:divisibility}{irreducible} factors.
  \item Two endomorphisms (or square matrices) are similar iff
        they have the same \omterm{thm:b3:modules:frobenius}{similarity invariants}.
\end{enumerate}
\end{theorem}

\begin{proof}
The structure theorem (\cref{thm:b3:modules:structure}) applied
to the \omterm{def:b3:rings:pidufd}{PID} $K[X]$: the \omterm{def:b3:modules:torsion}{torsion module} $V$ decomposes with
\omterm{thm:b3:modules:smith}{invariant factors} $P_i$, normalized monic (units of $K[X]$ are
$K^\times$); no \omterm{def:b3:modules:free}{free} part occurs ($V$ is \omterm{def:b3:modules:torsion}{torsion}). On each cyclic
...
(2) Similar endomorphisms are conjugate \omterm{def:b3:modules:module}{module} structures, hence
have equal invariants (uniqueness in
\cref{thm:b3:modules:structure}); conversely equal invariants
give isomorphic $K[X]$-modules, and a \omterm{def:b3:modules:module}{module} isomorphism is
...
\begin{proof}
The \omterm{thm:b3:modules:frobenius}{similarity invariants} of $M$ are computed by Smith's minor
...
the \omterm{thm:b3:modules:smith}{invariant factors} of $XI_n - M$, quotients of successive
minor gcds, are the same over $K$ and over $L$: $M, N$ have the
same \omterm{thm:b3:modules:frobenius}{similarity invariants} over $L$ iff over $K$; conclude by
...
\cref{thm:b3:modules:structure}) instead of \omterm{thm:b3:modules:smith}{invariant factors}:
\[
...
\begin{proof}
The \omterm{thm:b3:modules:structure}{elementary divisors} of the \omterm{def:b3:modules:torsion}{torsion module} $V$ are the
$(X - \lambda)^k$ with $X - \lambda$ ranging over the \omterm{def:b3:rings:divisibility}{irreducible}
factors of $\mu_u$ (which splits, since $\chi_u$ does and both
have the same \omterm{def:b3:rings:divisibility}{irreducible} factors,
...
Uniqueness of the multiset of \omterm{thm:b3:modules:structure}{elementary divisors} is
...
subsumed: all the combinatorics was the arithmetic of the \omterm{def:b3:rings:pidufd}{PID}
$K[X]$.
\end{remark}
...
(a) Show that $\Q$ is not \omterm{def:b3:modules:free}{finitely generated} as a $\Z$-module.
(b) Show that $\Q$ is \omterm{def:b3:modules:torsion}{torsion-free} but not \omterm{def:b3:modules:free}{free}.
...
Compute the \omterm{thm:b3:modules:smith}{Smith normal form} over $\Z$ of
\[
...
\cong \prod_i \Z/d_i\Z$ for the \omterm{thm:b3:modules:smith}{invariant factors} $d_i$ of $B$.
...
that $M/T(M)$ is \omterm{def:b3:modules:torsion}{torsion-free}. (b) Show that the \omterm{def:b3:rings:ideal}{ideal} $(X, Y)$
of $K[X,Y]$, as a $K[X,Y]$-module, is \omterm{def:b3:modules:torsion}{torsion-free} but not \omterm{def:b3:modules:free}{free}:
the structure theorem genuinely needs the \omterm{def:b3:rings:pidufd}{PID} hypothesis.
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:b3:modules:6}
(a) Show that $2\Z$ has no direct complement in the $\Z$-module
$\Z$: submodules of \omterm{def:b3:modules:free}{free modules} are \omterm{def:b3:modules:free}{free}
(\cref{thm:b3:modules:submodule}), but direct summands they need
not be. (b) Show that if $M \subseteq A^n$ ($A$ a \omterm{def:b3:rings:pidufd}{PID}) satisfies:
$A^n/M$ is \omterm{def:b3:modules:torsion}{torsion-free}, then $M$ \emph{is} a direct summand.
\end{exercise}
...
(a) Determine all \omterm{thm:b3:modules:frobenius}{similarity invariants} and possible \omterm{thm:b3:modules:jordan}{Jordan forms}
...
\omterm{def:b3:modules:companion}{companion matrix} has a cyclic vector, and determine when a
...
abelian group with \omterm{thm:b3:modules:smith}{invariant factors} $d_1 \mid d_2 \mid \dots
\mid d_s$.
...
$V$ is the $K[X]$-module defined by $u$, with \omterm{thm:b3:modules:smith}{invariant factors}
...
\begin{enumerate}
  ...
  \item Show that, modulo the columns of $XI_n - M$, every
        ...
        and deduce $\ker\varphi = (XI_n - M)\,K[X]^n$: the \omterm{def:b3:modules:module}{module}
        $V_M$ has presentation matrix $XI_n - M$. Recover
        \cref{cor:b3:modules:descent}'s starting point: the
        \omterm{thm:b3:modules:frobenius}{similarity invariants} of $M$ are the nonunit \omterm{thm:b3:modules:smith}{invariant
        factors} of $XI_n - M$.
  \item Compute the \omterm{thm:b3:modules:frobenius}{similarity invariants} of: a scalar matrix
...
\medskip
\noindent\textbf{Part II --- Morphisms between cyclic \omterm{def:b3:modules:module}{modules}.}
...
\medskip
\noindent\textbf{Part IV --- Dividends of the \omterm{thm:b3:modules:frobenius}{similarity
...
\begin{enumerate}[resume]
  \item (Transpose) Show that every $M \in M_n(K)$ is similar to
        ...
        the same Smith form: equal \omterm{thm:b3:modules:frobenius}{similarity invariants}.)}
  \item (Descent of similarity) Let $K \subseteq L$ be a field
        ...
        still a Smith form in $L[X]$ --- why do the \omterm{thm:b3:modules:smith}{invariant
  ...
  \item (A concrete pair) Determine the \omterm{thm:b3:modules:frobenius}{similarity invariants} of
  ...
  \item (\omterm{ex:b3:groups:actions}{Conjugacy classes} of $GL_2(\mathbb F_q)$) Using
        \omterm{thm:b3:modules:smith}{invariant factors}, show that every class of
        ...
        cyclic with \omterm{def:b3:rings:divisibility}{irreducible} characteristic polynomial.
  \item Count the classes of each type and conclude:
        $GL_2(\mathbb F_q)$ has exactly $q^2 - 1$ \omterm{ex:b3:groups:actions}{conjugacy
        classes}. \emph{(Count monic \omterm{def:b3:rings:divisibility}{irreducible} quadratics over
...
\begin{enumerate}[resume]
  \item (\omterm{ex:b3:groups:actions}{Center} of the commutant) Show that the \omterm{ex:b3:groups:actions}{center} of the
  ...
  \item (\omterm{cor:b3:groups:classeq}{Class equation} of $GL_2(\mathbb F_3)$) For $q = 3$,
        compute the size of each \omterm{ex:b3:groups:actions}{conjugacy class} of question 20
        ...
        three noncentral types, list the three monic \omterm{def:b3:rings:divisibility}{irreducible}
        quadratics over $\mathbb F_3$, and verify the \omterm{cor:b3:groups:classeq}{class
        equation}
        \[
