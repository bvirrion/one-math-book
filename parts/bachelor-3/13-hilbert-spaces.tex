...
the \emph{\omterm{rem:b3:hilbert:variational}{orthogonal polynomials}} $(p_n)$ for $w$ (monic
...
\begin{enumerate}[resume]
  \item Show $\deg P_n = n$ with leading coefficient
        ...
        normalization) the \omterm{rem:b3:hilbert:variational}{orthogonal polynomials} for $w = 1$.
...
\begin{enumerate}[resume]
  \item Show that $T_n(\cos\theta) = \cos n\theta$ defines a
        ...
        \]
        the $T_n$ are the \omterm{rem:b3:hilbert:variational}{orthogonal polynomials} for this
...
\begin{enumerate}[resume]
  ...
  \item (Jacobi matrix) Let $J_n$ be the $n\times n$
        ...
        the interlacing above) tying \omterm{rem:b3:hilbert:variational}{orthogonal polynomials}
