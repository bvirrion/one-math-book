...
\Q(\alpha, \iu)$, the splitting field of $X^4 - 2$ over $\Q$.
...
(c) Which intermediate fields are Galois over $\Q$? Match
your answer against the normal subgroups of $D_4$, and
...
\begin{enumerate}[resume]
  ...
  \item Unfold $\bigl(\frac{p^*}q\bigr) =
        ...
        lines whether $x^2 \equiv 219 \pmod{383}$ is solvable
        ($383$ is prime, $219 = 3\cdot73$).
\end{enumerate}

\medskip
\noindent\textbf{Part VI --- Counting irreducible polynomials:
the prime number theorem of $\mathbb F_q[X]$.} Fix a prime power
$q$ and let $N_q(n)$ be the number of \emph{monic irreducible}
polynomials of degree $n$ over $\mathbb F_q$; recall from
...
\begin{enumerate}[resume]
  \item (Words) Call a word $w \in \mathbb F_q^n$
        ...
        \mathbb F_{q^d}$ of degree $d$ has Frobenius orbit
        $(\alpha, \alpha^q, \dots, \alpha^{q^{d-1}})$ of
        exactly $d$ distinct elements, and elements of degree
        $d$ correspond $d$-to-one to irreducibles of degree
        $d$.
  ...
  \item Show $N_q(n) \geq \frac1n\bigl(q^n - 2q^{n/2}\bigr) > 0$
        ...
        monic polynomial of degree $n$ is irreducible with
        probability $\sim \frac1n$ --- the perfect analogue of
...
\begin{enumerate}[resume]
  ...
  \item (The zeta function of $\mathbb F_q[X]$) Prove the
        ...
        = \frac1{1 - qt}
        \]
        \emph{(unique factorization into monic irreducibles:
        expand each factor as a geometric series and count
        monic polynomials of degree $n$)}. Recover the identity
