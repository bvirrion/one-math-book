...
the norm, $\Z[\iu]$ is \omterm{def:b3:rings:pidufd}{Euclidean} (\cref{exo:b3:rings:4}), hence a
\omterm{def:b3:rings:pidufd}{PID} and a \omterm{def:b3:rings:pidufd}{UFD}, and \emph{Gaussian prime} means prime (=
\omterm{def:b3:rings:divisibility}{irreducible}) element of $\Z[\iu]$.
