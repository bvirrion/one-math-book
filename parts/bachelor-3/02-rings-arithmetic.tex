...
None of the implications Euclidean $\Rightarrow$ PID
$\Rightarrow$ UFD is an equivalence, and the failure of the
...
\]
All four factors are irreducible: their norms are $4, 9, 6,
...
factorizations of $6$ into irreducibles. Equivalently,
...
factorizing \emph{ideals} rather than elements --- is the
birth of algebraic number theory; at our level, the example
calibrates how special the Euclidean rings $\Z$, $K[X]$,
