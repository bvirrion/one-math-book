...
(a)~Les deux intervalles se chevauchent entre $0$ et $2$~:
...
$x < 1$~: $\intco{-2}{1}$. La réunion couvre tout~:
$I \cup J = \R$.
\end{solution}
...
nombre et son opposé ont la même valeur absolue).
\end{solution}
...
Chaque intervalle est décrit par son centre $a$ (milieu des bornes) et
