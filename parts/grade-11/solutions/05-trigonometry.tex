...
To radians: $30^\circ = \frac{\pi}{6}$, $45^\circ = \frac{\pi}{4}$,
...
the ordinate is negative: $\sin t = -\frac{12}{13}$.
\end{solution}
...
$t = \pm\frac\pi6$ (the shifts by $2k\pi$ leave the interval).

$\sin t = \frac12$: $t = \frac\pi6$ or $t = \pi - \frac\pi6 =
\frac{5\pi}{6}$.

$\cos t = -1$: the only point of abscissa $-1$ is $M(\pi)$, so $t = \pi$.
\end{solution}
...
Expanding both squares and using $\cos^2 x + \sin^2 x = 1$:
\[
...
On the unit circle, the points of abscissa exactly $\frac12$ are
$M\!\left(\pm\frac\pi3\right)$. The points with abscissa \emph{at most}
