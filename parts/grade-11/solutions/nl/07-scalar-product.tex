...
$(1,-4)\cdot(8,2) = 8 - 8 = 0$ (orthogonale vectoren).
...
De vectoren $\vect{AB}$ en $\vect{BC}$ maken een hoek van
...
meetkundig zijn $\vect{OA}\,(-3,0)$ en $\vect{OB}\,(0,2)$ orthogonaal,
...
De loodlijn door $P$ heeft de richtingsvector van $d$, namelijk
$(-1, 2)$, als normaalvector: vergelijking $-x + 2y + c = 0$; door
...
\emph{1.} Omdat $I$ het midden is, $\vect{IB} = -\vect{IA}$ en
$IA = 2$. Dan
\[
