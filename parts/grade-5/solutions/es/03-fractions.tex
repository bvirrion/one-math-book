\section*{Capítulo \ref{ch:g5:fractions} --- Fracciones como números}

\begin{solution}{exo:g5:fractions:1}
$\frac25$: dos pasos de $0$; $\frac55$: en $1$; $\frac85$: tres
pasos pasados $1$; $\frac{10}{5}$: en $2$.
\end{solution}
...
$\frac82 = 4$; \quad $\frac94$ no está completo ($9$ no es un múltiplo
...
$\frac35 > \frac37$ (mismo \omterm{def:g4:fractions:def}{numerador}: las quintas son más grandes). \quad
$\frac25 < \frac12 < \frac{7}{12}$, entonces $\frac25 < \frac{7}{12}$
(marca $\frac12$). \quad
$\frac98 > 1 > \frac{11}{12}$ (marca $1$).
\end{solution}
...
$\frac14$ h $= 15$ mín; $\frac12$ h $= 30$ mín; $\frac34$ h $= 45$
mín; $\frac{1}{60}$ h $= 1$ mín.
\end{solution}

\begin{solution}{exo:g5:fractions:10}
Tomás: $\frac35$ de $50 = 30$ CL. ana: $\frac12$ de $60 = 30$ CL. ellos
bebí la misma cantidad! el desnudo fracciones ($\frac35 > \frac12$)
comparar acciones de \emph{diferente} botellas --- sólo el real
