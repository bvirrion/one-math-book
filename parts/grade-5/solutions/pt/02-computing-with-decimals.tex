...
Pães: $1.15 \times 2 = 2.30$. Total: $2.30 + 12.60 = 14.90$. Troco:
$20 - 14.90 = 5.10$.
\end{solution}

\begin{solution}{exo:g5:decimalops:9}
Pacote: $1.5 \times 6 = 9$ L. Dias: $0.75 + 0.75 = 1.5$ L a cada dois
dias, então $9$ L duram $12$ dias (doze porções de $0.75$:
$12 \times 0.75 = 9$).
\end{solution}

\begin{solution}{exo:g5:decimalops:10}
Estimativa: $5.6$ é mais que $5.5$, e $5.5 \times 3 = 16.5$ --- então
o \omterm{def:g2:mult:def}{produto} tem de ser \emph{mais} que $16.5$, e $15.18$ é pequeno
demais. Corretamente: $56 \times 3 = 168$, com um algarismo decimal,
logo $5.6 \times 3 = 16.8$. Milo colou os dois \omterm{def:g2:mult:def}{produtos} parciais
($15$ e $18$) lado a lado em vez de somá-los com as casas certas:
$15 + 1.8 = 16.8$.
\end{solution}
...
\emph{2.} $261.4 > 260$: ela não bateu o recorde; ficou $1.4$ s
acima dele.
\end{solution}
