...
où va la virgule. Ce chapitre couvre les méthodes en colonnes et la
...
\begin{enumerate}
  \item Écrire les nombres avec les \emph{virgules alignées}
        (alors les unités sont sous les unités, les dixièmes sous
        les dixièmes)~;
  \item compléter la partie décimale plus courte avec des zéros~;
  \item additionner ou soustraire comme avec les entiers~;
  \item faire descendre la virgule du résultat droit en bas.
\end{enumerate}
\end{method}
...
\emph{virgule qui avance d'une place à droite}. Diviser fait
l'inverse~:
\[
...
gauche. La virgule ne bouge pas vraiment --- ce sont les chiffres
qui bougent.}
\end{omfigure}
