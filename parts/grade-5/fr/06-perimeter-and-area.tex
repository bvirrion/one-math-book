...
\emph{formule} d'\omterm{def:g4:measure:area}{aire} --- longueur fois largeur pour le rectangle ---
...
Un jardinier a besoin du \emph{\omterm{def:g4:measure:perimeter}{périmètre}} pour acheter la clôture et
de l'\emph{\omterm{def:g4:measure:area}{aire}} pour acheter le gazon. Les deux ne se suivent
pas~: étirer un rectangle plus fin et plus long peut garder son
\omterm{def:g4:measure:area}{aire} tandis que son \omterm{def:g4:measure:perimeter}{périmètre} grandit --- comparer un
$6 \times 2$ et un $4 \times 3$ (même \omterm{def:g4:measure:area}{aire} $12$, \omterm{def:g4:measure:perimeter}{périmètres} $16$ et
$14$).
\end{example}
...
unité) a pour \omterm{def:g4:measure:area}{aire}
\[
A = L \times \ell ,
\]
en unités d'\omterm{def:g4:measure:area}{aire}~: cm$^2$ (carrés de côté $1$~cm), m$^2$ (carrés de
côté $1$~m), \dots
\end{proposition}
...
Un tapis mesure $2.5$~m sur $2$~m~: \omterm{def:g4:measure:area}{aire} $2.5 \times 2 = 5$~m$^2$.
Un timbre mesure $3$~cm sur $2.4$~cm~: \omterm{def:g4:measure:area}{aire} $3 \times 2.4 = 7.2$
...
carrés. Les unités d'\omterm{def:g4:measure:area}{aire} sautent par centaines, pas par dizaines.
\end{example}
...
\begin{enumerate}
  \item la découper en rectangles, ou la compléter en un grand
        rectangle~;
  \item calculer chaque \omterm{def:g4:measure:area}{aire} rectangulaire avec la formule~;
...
même \omterm{def:g4:measure:area}{aire}~: chacun est la \emph{\omterm{def:g3:division:half}{moitié}} du rectangle. Un triangle
rectangle de côtés de l'\omterm{def:g3:shapes:rightangle}{angle droit} $6$~cm et $4$~cm a donc pour
\omterm{def:g4:measure:area}{aire} $\frac{6 \times 4}{2} = 12$~cm$^2$ --- une image à retenir
...
Calculer l'\omterm{def:g4:measure:area}{aire} et le \omterm{def:g4:measure:perimeter}{périmètre} d'un rectangle $8$~cm $\times$
$5$~cm. Quelle réponse est en cm, laquelle en cm$^2$~?
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g5:areas:2}
Calculer les \omterm{def:g4:measure:area}{aires}~: un carré de côté $9$~cm~; un rectangle
$12$~m $\times$ $7$~m~; un rectangle $4.5$~cm $\times$ $6$~cm.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g5:areas:3}
Un rectangle a une \omterm{def:g4:measure:area}{aire} de $63$~cm$^2$ et une longueur de $9$~cm.
Trouver sa largeur, puis son \omterm{def:g4:measure:perimeter}{périmètre}.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g5:areas:4}
Dessiner deux rectangles différents d'\omterm{def:g4:measure:area}{aire} $24$ carreaux sur papier
quadrillé, et calculer les deux \omterm{def:g4:measure:perimeter}{périmètres}. Même \omterm{def:g4:measure:area}{aire} --- même
\omterm{def:g4:measure:perimeter}{périmètre}~?
\end{exercise}
...
une barre verticale $2 \times 5$ (en cm). Calculer son \omterm{def:g4:measure:area}{aire} en
...
\omterm{def:g4:measure:area}{aire} de bois le cadre utilise-t-il~?
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g5:areas:8}
Calculer l'\omterm{def:g4:measure:area}{aire} d'un triangle rectangle de côtés de l'\omterm{def:g3:shapes:rightangle}{angle droit}
$8$~cm et $6$~cm (\omterm{def:g3:division:half}{moitié} d'un rectangle,
...
devient son \omterm{def:g4:measure:perimeter}{périmètre}~? Son \omterm{def:g4:measure:area}{aire}~? (Calculer les deux avant et
