...
\begin{enumerate}
  ...
  \item Reste~: $30 - 17 = 13$ --- exactement assez pour le jeu,
        sans rien laisser.
\end{enumerate}
\end{example}
...
la moitié de la pluie d'avril ($30$ contre $70$~? non --- la moitié
de $70$ est $35$, donc \emph{pas tout à fait} la moitié~: lire
...
\emph{différence} de billets --- et vérifier que les réponses
coïncident.
\end{exercise}
