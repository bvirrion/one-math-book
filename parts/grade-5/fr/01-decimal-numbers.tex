...
Après la virgule viennent les dixièmes, les centièmes, les
...
bleu, partie décimale en rouge, la virgule entre unités et
dixièmes.}
\end{omfigure}

\begin{example}[Plusieurs lectures, un seul nombre]\label{ex:g5:decimals:readings}
$4.362$ peut se lire «~quatre virgule trois six deux~», ou «~quatre
et $362$ millièmes~», ou se décomposer en $4 + 0.3 + 0.06 + 0.002$.
Et ajouter des zéros finaux ne change rien~: $4.362 = 4.3620$.
Mais $4.362 \neq 4.0362$~: un zéro \emph{à l'intérieur} pousse
...
\begin{enumerate}
  ...
  \item Parties entières égales~: comparer les parties décimales
        chiffre par chiffre depuis la virgule --- dixièmes, puis
        centièmes, puis millièmes~;
  \item compléter avec des zéros finaux rend la comparaison
...
Pour arrondir à l'unité (ou au dixième, ou au centième), on regarde
...
$7.4983 \to 7.50$, où le $49$ est devenu $50$ --- l'arrondi peut
...
virgule qui s'arrondissent à $6.4$ lorsqu'on arrondit au dixième.
