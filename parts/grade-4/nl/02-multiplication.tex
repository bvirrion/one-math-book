...
Vermenigvuldigen met $10$ voegt \'{e}\'{e}n \omterm{def:g1:counting:zero}{nul} toe, met $100$ twee
...
\]
De kolommethode schrijft precies deze twee \omterm{def:g2:mult:def}{producten}, de ene onder
...
\omterm{def:g2:mult:def}{producten}, $200 + 40 + 30 + 6 = 276$. De kolommethode groepeert ze
...
\begin{itemize}
  ...
  \item \emph{Verdubbelen en halveren}: $16 \times 35 = 8 \times 70 =
        ...
        het \omterm{def:g2:mult:def}{product}).
\end{itemize}
\end{example}
...
narcissen. Hoeveel bloemen in totaal? (Twee \omterm{def:g2:mult:def}{producten}, dan een \omterm{def:g1:addition:def}{som}.)
\end{exercise}
