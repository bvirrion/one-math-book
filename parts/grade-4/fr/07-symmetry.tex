...
dont les deux \omterm{def:g3:division:half}{moitiés} coïncident quand on les plie. Ce chapitre
...
fait coïncider les deux \omterm{def:g3:division:half}{moitiés} \emph{exactement}. Une figure peut
...
{\small Plier le long du trait en pointillés~: les \omterm{def:g3:division:half}{moitiés}
coïncident. Le dernier triangle n'a aucun pli qui fonctionne ---
pas d'\omterm{def:g4:symmetry:def}{axe de symétrie}.}
\end{omfigure}
...
\begin{enumerate}
  \item Prendre chaque \omterm{def:g4:geometry:polygon}{sommet} de la figure à tour de rôle~;
  \item compter sa distance à l'axe en carreaux~;
  \item placer le \omterm{def:g4:geometry:polygon}{sommet} image à la \emph{même} distance de
        \emph{l'autre} côté, sur la même ligne (ou colonne)~;
  \item joindre les \omterm{def:g4:geometry:polygon}{sommets} images dans le même ordre, et
...
{\small Compléter par rapport à l'axe rouge~: chaque \omterm{def:g4:geometry:polygon}{sommet} saute à
la même distance de l'autre côté. Les \omterm{def:g4:geometry:polygon}{sommets} touchant l'axe
...
Calquer et plier~: lesquelles de ces figures ont un \omterm{def:g4:symmetry:def}{axe de
...
Dessiner les \omterm{def:g4:symmetry:def}{axes de symétrie} de~: un carré~; un rectangle~; un
...
\emph{n'est pas} un \omterm{def:g4:symmetry:def}{axe de symétrie}.
\end{exercise}
...
Une figure touche son \omterm{def:g4:symmetry:def}{axe de symétrie} en un point $P$. Où se trouve
...
Un triangle a pour côtés $5$~cm, $5$~cm et $3$~cm. A-t-il un \omterm{def:g4:symmetry:def}{axe de
...
\emph{exactement deux} \omterm{def:g4:symmetry:def}{axes de symétrie}, et tracer les deux axes.
(Indice~: penser à un rectangle, ou à une croix.)
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g4:symmetry:10}
La \omterm{def:g3:division:half}{moitié} d'un dessin symétrique est donnée~: la \omterm{def:g3:division:half}{moitié} gauche d'une
maison (un mur carré et la \omterm{def:g3:division:half}{moitié} d'un toit triangulaire), avec un
axe vertical le long de son bord droit. Décrire ou dessiner la
maison complète. Comment les longueurs de la \omterm{def:g3:division:half}{moitié} droite complétée
se comparent-elles à celles de la \omterm{def:g3:division:half}{moitié} gauche~?
\end{exercise}

\begin{exercise}[$\star\star$]\label{exo:g4:symmetry:11}
Aya affirme~: «~tout triangle avec deux côtés égaux a un \omterm{def:g4:symmetry:def}{axe de
symétrie}, et tout triangle avec un \omterm{def:g4:symmetry:def}{axe de symétrie} a deux côtés
