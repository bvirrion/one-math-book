...
comptage soigneux sont justes~; le \omterm{def:g4:measure:perimeter}{périmètre} dépend du L choisi.)
\end{solution}

\begin{solution}{exo:g4:measure:6}
$3 \times 4$~: \omterm{def:g4:measure:perimeter}{périmètre} $14$. $2 \times 6$~: \omterm{def:g4:measure:perimeter}{périmètre} $16$.
($1 \times 12$~: \omterm{def:g4:measure:perimeter}{périmètre} $26$.) Plus on se rapproche d'un carré,
plus le \omterm{def:g4:measure:perimeter}{périmètre} est petit pour une même \omterm{def:g4:measure:area}{aire}.
\end{solution}

\begin{solution}{exo:g4:measure:7}
\omterm{def:g3:division:half}{Moitié} du rectangle $6 \times 3$~: $18 \div 2 = 9$ carreaux.
\end{solution}
...
\omterm{def:g4:measure:perimeter}{Périmètre}~: $4 \times 85 = 340$~m~; moins le portail~:
$340 - 4 = 336$~m de clôture.
\end{solution}

\begin{solution}{exo:g4:measure:11}
Les deux affirmations sont \emph{fausses}. Même \omterm{def:g4:measure:perimeter}{périmètre}, \omterm{def:g4:measure:area}{aires}
différentes~: le rectangle $4 \times 2$ et la forme en L de la
figure du chapitre (tous deux \omterm{def:g4:measure:perimeter}{périmètre} $12$~; \omterm{def:g4:measure:area}{aires} $8$ et $6$).
Même \omterm{def:g4:measure:area}{aire}, \omterm{def:g4:measure:perimeter}{périmètres} différents~: le carré $4 \times 4$ et le
rectangle $8 \times 2$ (tous deux \omterm{def:g4:measure:area}{aire} $16$~; \omterm{def:g4:measure:perimeter}{périmètres} $16$ et
$20$).
\end{solution}
