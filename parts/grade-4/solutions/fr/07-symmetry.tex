...
\omterm{def:g4:geometry:polygon}{sommet}).
\end{solution}

\begin{solution}{exo:g4:symmetry:3}
En pliant le long de la diagonale, les deux \omterm{def:g3:division:half}{moitiés} triangulaires
...
Oui~: le triangle est isocèle, et son axe passe par le \omterm{def:g4:geometry:polygon}{sommet} entre
...
La maison complète est la \omterm{def:g3:division:half}{moitié} gauche plus son jumeau miroir~: un
...
le long de la droite passant par son \omterm{def:g4:geometry:polygon}{sommet} (deux côtés égaux
