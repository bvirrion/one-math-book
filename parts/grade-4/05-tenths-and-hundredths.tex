...
hundred, gives the \emph{decimal \omterm{def:g4:fractions:def}{fractions}}, and a wonderful
shorthand for them: the \omterm{def:g4:decimals:point}{decimal point}. (Decimal numbers get their
...
2.37
\]
--- the \emph{decimal point}\index{decimal point} separates the whole part ($2$) from the
...
\omterm{def:g4:decimals:point}{decimal point} you already use every day: $10$ cents $= 0.10$; two
...
$2$ columns and $3$ cells; $45$ cells? Answer with \omterm{def:g4:fractions:def}{fractions}.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g4:decimals:2}
Write with a \omterm{def:g4:decimals:point}{decimal point}:
$\frac{9}{10}$; \quad $\frac{27}{100}$; \quad $\frac{3}{100}$; \quad
$5 + \frac{6}{10}$; \quad $\frac{60}{100}$.
\end{exercise}

\begin{exercise}[$\star$]\label{exo:g4:decimals:3}
Write as a \omterm{def:g4:fractions:def}{fraction} (tenths or hundredths):
