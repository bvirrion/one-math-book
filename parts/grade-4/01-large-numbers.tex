...
is to cut their digits into groups of three --- the classes.
...
12\,040\,500 .
\]
The zeros of $040$ are essential: each class (except the leftmost)
...
Exactly as in \cref{met:g3:numbers:compare}, with the classes as a
...
$6$, so round up: $38\,000$. Rounded to the nearest hundred:
...
{\small Rounding $37\,614$ to the nearest thousand: it lies past the
halfway mark $37\,500$, so it rounds up to $38\,000$.}
\end{omfigure}

\begin{example}[Orders of magnitude in the world]\label{ex:g4:numbers:world}
Rounding is how large numbers are actually used: a country of
...
Write in digits, with the classes separated: ``three million five
...
of $100\,000$ from $950\,000$. What happens to the classes as you
cross a million?
\end{exercise}
...
right? To which place did each round?
\end{exercise}
...
What is the biggest whole number that rounds to $50\,000$ when
rounding to the nearest thousand? And the smallest?
\end{exercise}
