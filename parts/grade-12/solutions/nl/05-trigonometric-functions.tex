...
minimum $1$ in $0$, maximum $2\pi + 1$ in $2\pi$. Op $\R$ is
$f' \geq 0$ overal met alleen geïsoleerde nulpunten, dus is $f$
(strikt) stijgend volgens \cref{thm:g12:deriv:variations}, hoewel $f'$
...
\emph{2.} Omdat $\cos$ beeld $\intcc{-1}{1}$ heeft, heeft $f$ maximum $R$
en minimum $-R$. Voor $\cos x + \sin x$: $A = B = 1$, $R = \sqrt2$,
$\varphi = \frac\pi4$, dus de vergelijking wordt
