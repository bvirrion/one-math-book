...
$\abs{z_1} = \sqrt2$, argument $\frac{3\pi}{4}$ (deuxième quadrant)~:
...
purement imaginaire signifie que les vecteurs de $A(1,0)$ vers $M$ et de
$B(-1,0)$ vers $M$ sont orthogonaux~: $M$ voit le segment $[AB]$ sous un
...
d'un carré de circonférence de rayon $\sqrt 2$. En groupant les racines
conjuguées,
\[
...
\emph{factorisation en demi-angle}). En prenant les parties réelles~:
\[
...
\emph{1.} $\omega$ est une racine $5$-ième de l'unité différente de $1$,
donc la somme des cinq racines s'annule
...
\]
Donc $u, v$ sont les racines de $X^2 + X - 1 = 0$~:
