...
(\cref{exo:tle:seq:6}): each vertical step reads $f(u_n)$ on the curve,
each horizontal step carries it back through $y = x$. The sequence climbs
to the fixed point $\ell = 2$, where the curve meets the line.}
\end{omfigure}
