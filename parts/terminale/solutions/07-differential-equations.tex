...
\begin{solution}{exo:tle:diffeq:1}
...
\begin{solution}{exo:tle:diffeq:2}
...
\begin{solution}{exo:tle:diffeq:3}
$y_p'(x) = \eu^x + x\eu^x = y_p(x) + \eu^x$: $y_p$ is a particular solution
(this is the resonant case of \cref{met:tle:diffeq:particular}). By
\cref{prop:tle:diffeq:general}, the solutions are
$y = C\eu^{x} + x\eu^{x} = (C + x)\,\eu^x$, $C \in \R$.
\end{solution}

\begin{solution}{exo:tle:diffeq:4}
...
\begin{solution}{exo:tle:diffeq:5}
$N(t) = N_0\,\eu^{-\lambda t}$ with $\lambda = \frac{\ln 2}{5730}$
(\cref{ex:tle:exp:halflife}). We solve $\eu^{-\lambda t} = 0.6$:
\[
...
\begin{solution}{exo:tle:diffeq:6}
...
\begin{solution}{exo:tle:diffeq:7}
...
\begin{solution}{exo:tle:diffeq:8}
...
\begin{solution}{exo:tle:diffeq:9}
By \cref{thm:tle:diffeq:affine}, $y(x) = C\eu^{ax} - \frac ba$. Hence
\[
