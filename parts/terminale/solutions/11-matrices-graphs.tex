...
\begin{solution}{exo:tle:matrix:1}
\[
...
\begin{solution}{exo:tle:matrix:2}
$\det A = 6 - 5 = 1 \neq 0$:
$A^{-1} = \begin{pmatrix} 3 & -5\\ -1 & 2 \end{pmatrix}$.
$\det B = 12 - 12 = 0$: $B$ is not invertible.
\end{solution}

\begin{solution}{exo:tle:matrix:3}
The system is $AX = Y$ with $A$ as in \cref{exo:tle:matrix:2} and
...
\begin{solution}{exo:tle:matrix:4}
...
\begin{solution}{exo:tle:matrix:5}
...
\begin{solution}{exo:tle:matrix:6}
...
\begin{solution}{exo:tle:matrix:7}
...
\begin{solution}{exo:tle:matrix:8}
\emph{1.} $\det P = -2$, so
...
exactly the formulas of \cref{ex:tle:matrix:coupled}.
\end{solution}
