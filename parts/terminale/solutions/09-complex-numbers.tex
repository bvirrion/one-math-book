...
\begin{solution}{exo:tle:complex:1}
...
\begin{solution}{exo:tle:complex:2}
...
\begin{solution}{exo:tle:complex:3}
...
\begin{solution}{exo:tle:complex:4}
...
\emph{(c)} By \cref{prop:tle:complex:geometry}(4), $\frac{z-1}{z+1}$ purely
...
\begin{solution}{exo:tle:complex:5}
...
\begin{solution}{exo:tle:complex:6}
\[
...
\]
(Consistent with $W_3 = \frac23$ in \cref{exo:tle:integ:9}, since
$\int_0^{\pi/2}\cos^3 = \int_0^{\pi/2}\sin^3$ by the symmetry
$\theta \mapsto \frac\pi2 - \theta$.)
\end{solution}

\begin{solution}{exo:tle:complex:7}
...
\begin{solution}{exo:tle:complex:8}
...
\begin{solution}{exo:tle:complex:9}
With $q = \eu^{\iu\theta} \neq 1$:
\[
...
\begin{solution}{exo:tle:complex:10}
\emph{1.} $\omega$ is a $5$-th root of unity different from $1$, so the sum
of all five roots vanishes (\cref{thm:tle:complex:rootsofunity}), which reads
