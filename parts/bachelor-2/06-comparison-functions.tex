...
(continuous, positive, decreasing): $\int_2^x f = \ln\ln x -
...
with the identical scale in the continuous variable.
...
An asymptotic expansion is attached to a \emph{scale}: writing
...
\int_2^x\frac{\dd t}{\ln t}$ (the integrand is continuous on
