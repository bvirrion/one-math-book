...
Le r\'esultat est le \emph{produit}\index{produit} (la multiplication grandit dans
\cref{ch:g3:mult}).
\end{definition}
...
\begin{itemize}
  ...
  \item table de $5$~: $5, 10, 15, 20, 25, \dots$ (se termine par
        $5$ ou $0$)~;
  \item table de $10$~: $10, 20, 30, \dots$ (ajouter un \omterm{def:g1:counting:zero}{z\'ero}).
\end{itemize}
\end{method}
