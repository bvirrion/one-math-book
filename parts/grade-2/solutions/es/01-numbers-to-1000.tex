\section*{Capítulo \ref{ch:g2:numbers} --- Los números hasta 1000}

\begin{solution}{exo:g2:numbers:1}
$258$: $2$ centenas, $5$ decenas y $8$ unidades. $470$: $4$, $7$ y $0$.
$600$: $6$, $0$, $0$. $909$: $9$, $0$, $9$.
\end{solution}
...
$195, 205, 215, 225, 235$ (el primer salto llena las decenas y
obliga a llevar). $300, 400, 500, 600, 700$.
\end{solution}

\begin{solution}{exo:g2:numbers:9}
$6$ centenas y $5$ unidades: $600 + 5 = 605$ lápices.
\end{solution}

\begin{solution}{exo:g2:numbers:10}
El mayor: $852$. El menor: $258$. Distancia:
$852 - 258 = 594$.
\end{solution}
