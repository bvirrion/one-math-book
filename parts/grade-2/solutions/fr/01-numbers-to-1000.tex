\section*{Chapitre \ref{ch:g2:numbers} --- Les nombres jusqu'\`a 1000}

\begin{solution}{exo:g2:numbers:1}
$258$~: $2$ centaines, $5$ dizaines, $8$ unit\'es. $470$~: $4$, $7$,
$0$. $600$~: $6$, $0$, $0$. $909$~: $9$, $0$, $9$.
\end{solution}
...
$195, 205, 215, 225, 235$ (le premier saut remplit les dizaines et
d\'eborde). $300, 400, 500, 600, 700$.
\end{solution}

\begin{solution}{exo:g2:numbers:9}
$6$ centaines et $5$ unit\'es~: $600 + 5 = 605$ crayons.
\end{solution}

\begin{solution}{exo:g2:numbers:10}
Le plus grand~: $852$. Le plus petit~: $258$. Distance~:
$852 - 258 = 594$.
\end{solution}
