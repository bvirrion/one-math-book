...
$35 = 20 + 10 + 5$. (D'autres façons sont possibles.)
\end{solution}
...
demie ($4{:}30$). Grande aiguille sur $3$, petite juste après
...
Après mai~: juin. Avant janvier~: décembre. (Le mois
d'anniversaire varie.)
\end{solution}

\begin{solution}{exo:g2:measure:8}
Dépense~: $3 + 4 = 7$. Monnaie~: $10 - 7 = 3$.
\end{solution}
...
façons avec exactement quatre pièces ou billets).
\end{solution}
