\section*{अध्याय \ref{ch:g2:numbers} --- 1000 तक की संख्याएँ}

\begin{solution}{exo:g2:numbers:1}
$258$: $2$ सैकड़ा, $5$ दहाई, $8$ इकाई। $470$: $4$, $7$, $0$।
$600$: $6$, $0$, $0$। $909$: $9$, $0$, $9$।
\end{solution}
...
$195, 205, 215, 225, 235$ (पहली छलाँग दहाई भर देती है और हासिल
बनता है)। $300, 400, 500, 600, 700$।
\end{solution}

\begin{solution}{exo:g2:numbers:9}
$6$ सैकड़ा और $5$ इकाई: $600 + 5 = 605$ पेंसिलें।
\end{solution}

\begin{solution}{exo:g2:numbers:10}
सबसे बड़ी: $852$। सबसे छोटी: $258$। फ़ासला:
$852 - 258 = 594$।
\end{solution}
