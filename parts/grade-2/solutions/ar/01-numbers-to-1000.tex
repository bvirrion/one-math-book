\section*{الفصل \ref{ch:g2:numbers} --- الأعداد حتى 1000}

\begin{solution}{exo:g2:numbers:1}
$258$: $2$ مئات و $5$ عشرات و $8$ آحاد. $470$: $4$ و $7$ و $0$.
$600$: $6$ و $0$ و $0$. $909$: $9$ و $0$ و $9$.
\end{solution}
...
$195, 205, 215, 225, 235$ (القفزة الأولى تملأ العشرات
فتحمل إلى المئات). $300, 400, 500, 600, 700$.
\end{solution}

\begin{solution}{exo:g2:numbers:9}
$6$ مئات و $5$ آحاد: $600 + 5 = 605$ قلمًا.
\end{solution}

\begin{solution}{exo:g2:numbers:10}
الأكبر: $852$. والأصغر: $258$. والمسافة بينهما:
$852 - 258 = 594$.
\end{solution}
