...
Lápis: cm. Comprimento da sala: m. Pena: g. Mochila: kg. Garrafa de
água: L.
\end{solution}
...
Ponteiro grande no $6$, pequeno entre $4$ e $5$: quatro e meia
($4{:}30$). Ponteiro grande no $3$, pequeno logo depois do $8$: oito
e quinze ($8{:}15$).
\end{solution}

\begin{solution}{exo:g2:measure:6}
Duas e meia: o ponteiro grande aponta para baixo, para o $6$, e o
ponteiro pequeno fica entre o $2$ e o $3$.
\end{solution}

\begin{solution}{exo:g2:measure:7}
Depois de maio: junho. Antes de janeiro: dezembro. (O mês do
aniversário varia.)
\end{solution}

\begin{solution}{exo:g2:measure:8}
Gastou: $3 + 4 = 7$. Troco: $10 - 7 = 3$.
\end{solution}

\begin{solution}{exo:g2:measure:9}
$1$ kg $= 1000$ g, que é mais que $800$ g: o açúcar é mais pesado,
por $1000 - 800 = 200$ g.
\end{solution}

\begin{solution}{exo:g2:measure:10}
Por exemplo, $20 + 10 + 5 + 5 = 40$ e $10 + 10 + 10 + 10 = 40$
(duas maneiras com exatamente quatro moedas ou notas).
\end{solution}
