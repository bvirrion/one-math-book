...
When the units of a \omterm{def:g1:addition:def}{sum} pass nine, ten of them bundle into a new
...
For small \omterm{def:g1:addition:def}{sums}, jump to a round number first:
\[
48 + 6 = 48 + 2 + 4 = 50 + 4 = 54 .
\]
