...
\begin{enumerate}
  ...
  \item En déduire que, pour tout $\lambda > 0$, l'équation $F(x) =
        ...
        ici au niveau du secondaire et démontré au
...
trigonométrie du secondaire.\index{télescopage}\index{problème de Bâle}
Partout, $\omega = \eu^{2\iu\pi/n}$~; les limites de suites sont
admises telles quelles ici (le \cref{ch:b1:seq} les formalise).
