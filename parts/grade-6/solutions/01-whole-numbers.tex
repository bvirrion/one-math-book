...
$95 = 7 \times 13 + 4$ (quotient $13$, remainder $4$).

$230 = 6 \times 38 + 2$ (quotient $38$, remainder $2$).

$504 = 8 \times 63 + 0$ (quotient $63$, remainder $0$: $504$ is
divisible by $8$).
\end{solution}

\begin{solution}{exo:g6:wholes:8}
The equality is true, but the remainder $13$ is \emph{not} smaller than
the divisor $8$, so it is not the Euclidean division. Take one more
$8$ out of the remainder: $173 = 8 \times 21 + 5$, with $0 \leq 5 < 8$:
quotient $21$, remainder $5$.
\end{solution}
...
The largest possible remainder in a division by $9$ is $8$ (the
remainder must be smaller than the divisor). So the dividend is
\[
