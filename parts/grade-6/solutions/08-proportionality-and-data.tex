...
Apples: quotients $\frac52 = 2.5$, $\frac{7.5}{3} = 2.5$,
$\frac{12.5}{5} = 2.5$ --- all equal: proportional (price
$2.50$ per kg).
...
$50\,\%$ of $84$: half, $42$. \quad
$25\,\%$ of $200$: a quarter, $50$. \quad
...
not, one would round \emph{up} to have enough.)
\end{solution}

\begin{solution}{exo:g6:propdata:10}
\emph{1.} In $2$ h: $48$ km. In half an hour: $12$ km. In
$1$ h $30$: $24 + 12 = 36$ km.
...
$80\,\%$ of the old one in every case: proportional, coefficient
$0.8$.
\end{solution}
...
$1 - \frac34 = \frac14$ --- indeed half of it.
\end{solution}
