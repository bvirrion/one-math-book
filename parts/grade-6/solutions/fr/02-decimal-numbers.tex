...
$0.7 = 0.70$ (les zéros finaux ne changent rien)~; \quad
...
À l'unité~: $24$ (chiffre suivant $8$~: arrondir vers le haut). Au
...
virgule le plus tard possible~: $85.2$. Le plus petit~: les plus
petits chiffres en premier et la virgule le plus tôt possible~:
$2.58$.
\end{solution}
