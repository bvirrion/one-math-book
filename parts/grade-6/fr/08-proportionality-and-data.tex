...
ainsi sont \emph{proportionnelles} --- l'une des idées les plus utiles
...
proportionnel~: tous les «~quotients de colonnes~»
...
donnent des quotients $\frac{1.50}{12} = 0.125$ et
...
«~$t\,\%$ d'une quantité~» signifie la fraction $\frac{t}{100}$ de
celle-ci~: $25\,\%$ de $60$ est $\frac{25}{100} \times 60 = 15$. Un
pourcentage est une proportionnalité de coefficient $\frac{t}{100}$.
\end{definition}
...
$50\,\%$ est une moitié, $25\,\%$ un quart, $10\,\%$ un dixième ---
...
{\small Les quantités proportionnelles ont un graphique très
...
d'écrire un nombre décimal d'œufs~!)
\end{exercise}
...
les hauteurs restantes après $t$ heures comme fractions de la hauteur
initiale.)
\end{exercise}
