...
\begin{itemize}
  \item de \emph{driehoek} heeft $3$ zijden en $3$ hoeken;
  \item het \emph{vierkant} heeft $4$ gelijke zijden en $4$ hoeken;
  \item de \emph{rechthoek} heeft $4$ zijden en $4$ hoeken, met
        overstaande zijden gelijk (een uitgerekt vierkant);
  \item de \emph{cirkel} is perfect rond: geen zijden, geen hoeken.
\end{itemize}
\end{definition}
