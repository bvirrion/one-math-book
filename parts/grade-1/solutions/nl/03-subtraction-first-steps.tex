...
$11 - 8 = 3$ (van $8$ door naar $11$); \quad
$13 - 9 = 4$; \quad $16 - 12 = 4$.
\end{solution}
...
$15 - 8 = 7$. Er blijven $7$ kersen over.
\end{solution}

\begin{solution}{exo:g1:subtraction:8}
``$5$ zwemmen weg'': $9 - 5 = 4$ eenden. ``Er komen $5$ gansjes bij'':
$9 + 5 = 14$ vogels. ``Hoeveel jaar ouder'': $9 - 5 = 4$ jaar.
\end{solution}

\begin{solution}{exo:g1:subtraction:9}
Het gezin van $12$, $7$ en $5$: $12 - 7 = 5$ eieren zijn uitgekomen
(en $5 + 7 = 12$ bevestigt het).
\end{solution}
