...
\begin{tikzpicture}[scale=0.7]
  ...
  \node[below, font=\small] at (1,-0.3) {triangle: $3$ sides};
  \begin{scope}[xshift=3.6cm]
  \draw[thick, fill=omThm!12] (0,0) rectangle (1.7,1.7);
  \node[below, font=\small] at (0.85,-0.3) {square};
  \end{scope}
  \begin{scope}[xshift=6.9cm]
  \draw[thick, fill=omMeth!12] (0,0) rectangle (2.8,1.6);
  \node[below, font=\small] at (1.4,-0.3) {rectangle};
  \end{scope}
  \begin{scope}[xshift=11.3cm]
  \draw[thick, fill=omProp!12] (0.9,0.85) circle (0.9);
  \node[below, font=\small] at (0.9,-0.3) {circle: no corner};
  \end{scope}
\end{tikzpicture}
...
\begin{tikzpicture}[scale=0.75]
  ...
  \draw[thick, fill=omMeth!12] (4.4,0) -- (5.5,0) -- (4.95,0.95)
    -- cycle;
  \node[below, font=\small] at (0,-0.75) {circle};
  \node[below, font=\small] at (2.45,-0.75) {square};
  \node[below, font=\small] at (4.95,-0.35) {triangle};
  \node[right, font=\small, align=left] at (6.3,0.1)
...
\begin{tikzpicture}[scale=0.6]
  ...
  \draw[-Stealth, omDef, very thick] (0.5,0.5) -- (2.5,0.5);
  \draw[-Stealth, omDef, very thick] (2.5,0.5) -- (2.5,2.5);
  \draw[-Stealth, omDef, very thick] (2.5,2.5) -- (5.1,2.5);
\end{tikzpicture}

{\small A path from start to goal:
$\to\ \to\ \uparrow\ \uparrow\ \to\ \to\ \to$. Can you find another
path with the same number of steps?}
\end{omfigure}
