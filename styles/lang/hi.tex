% ============================================================================
% Hindi UI and structural strings for the One Math Book series.
% Loaded by styles/onemath.sty when \booklang is hi.
...
\newcommand{\booktagline}{सब पर राज करने वाली एक गणित की पुस्तक}
\newcommand{\bookdescription}{किंडरगार्टन से स्नातक की डिग्री के अंत तक गणित}
\newcommand{\bookcontributors}{One Math Book के योगदानकर्ता}
