...
\newcommand{\booktagline}{Het wiskundeboek om ze allen te regeren}
...
% cleveref keeps English conjunctions unless told otherwise, so a Dutch book
% printed "Hoofdstukken 11 and 13" and "Hoofdstukken 11 to 13". cleveref
% installs its own at \begin{document}, hence the hook. (The other language
% files have the same gap.)
\AtBeginDocument{%
