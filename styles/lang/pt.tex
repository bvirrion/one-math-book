% ============================================================================
% Brazilian Portuguese UI and structural strings for the One Math Book series.
% Loaded by styles/onemath.sty when \booklang is pt.
% ============================================================================
...
\newcommand{\booktagline}{O livro de matemática para governá-los a todos}
\newcommand{\bookdescription}{A matemática da educação infantil ao fim da graduação}
\newcommand{\bookcontributors}{Os colaboradores do One Math Book}
...
% Part titles (Anos 1–12; parallel to English Grade N)
...
% Part titles (Graduação 1–3; parallel to English Bachelor Year N).
...
% cleveref keeps its English conjunctions unless told otherwise: \cref{a,b}
% printed "Capítulos 25 and 29" and "Capítulos 25 to 29" in the middle of
% Portuguese prose. cleveref installs its own at \begin{document}, hence the
% hook. (Mirrors styles/lang/nl.tex; the other language files have the gap.)
\AtBeginDocument{%
...
% read "July 31, 2026" on a Portuguese book. Brazilian Portuguese writes it as
% "31 de julho de 2026", month lowercase.
...
% LaTeX's own structural names (babel may be absent).
